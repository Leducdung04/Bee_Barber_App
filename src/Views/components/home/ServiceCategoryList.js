    ...
    <TouchableOpacity onPress={() => onClick()}>
      <View
        style={[
          ...
          {margin: 4, height: itemHeight, marginVertical: 8},
        ]}>
        <Image
          style={{height: itemHeight, width: widthItem, borderRadius: 12}}
  ...
  return (
    <View style={styles.container}>
      <View style={styles.titleContainer}>
        ...
        <Text style={[globalStyles.textTitle, {marginStart: 12}]}>
          Dịch vụ{' '}
        </Text>
      </View>
      <FlatList
